...
function SummaryStrip({ items }: { items: Array<{ label: string; value: string; detail: string }> }) {
  return (
    <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
      {items.map((item) => (
        <div key={item.label} className="rounded-lg border border-[#e0e4ea] bg-white px-4 py-3">
  ...
  return (
    ...
    >
      <div className="space-y-3">
        {items.map((item) => (
          <article key={item.id} className="rounded-lg border border-[#e0e4ea] bg-white p-4">
    ...
    <DashboardSectionCard title={copy.assignmentTitle} description={copy.assignmentDescription}>
      <div className="space-y-3">
        {assignmentRuns.map((assignment) => (
          <article key={assignment.id} className="rounded-lg border border-[#e0e4ea] bg-white p-4">
...
function SchoolHealthPanel({
  ...
  return (
    <DashboardSectionCard title={copy.schoolHealthTitle} description={copy.schoolHealthDescription}>
      <div className="space-y-3">
        {schools.map((school) => (
          <article key={school.id} className="rounded-lg border border-[#e0e4ea] bg-white p-4">
  ...
  return (
    ...
    >
      <div className="overflow-hidden rounded-lg border border-[#e0e4ea] bg-white">
        <div className="hidden grid-cols-[minmax(0,1.3fr)_120px_120px_120px_130px] gap-3 border-b border-[#e0e4ea] bg-[#f7f8fa] px-4 py-3 text-[11px] font-semibold text-slate-600 lg:grid">
