...
import { loadLmsDashboardBootstrap } from "@/features/dashboard/api/lms-dashboard-api";
import { AttendanceSheetPanel } from "@/features/dashboard/components/attendance-sheet-panel";
import { ScoreSheetPanel } from "@/features/dashboard/components/score-sheet-panel";
import { TeachingSchedulePanel } from "@/features/dashboard/components/teaching-schedule/teaching-schedule-panel";
import { WeeklyClassLogPage } from "@/features/weekly-class-log";
import { HocLieuLibraryPage } from "@/features/hoclieu/components/hoclieu-library-page";
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <main className="min-h-0 flex-1 overflow-y-auto">
          {activeSection === "resources" ? (
            <HocLieuDashboardScopeProvider value={hocLieuScope}>
              <HocLieuLibraryPage />
                ...
                return (
                  <tr key={student.id} className="group">
                    ...
                    <AttendanceStickyCell className="left-[234px] z-20 w-[66px] text-center font-semibold text-slate-600">
                      {student.className.replace("Lá»›p ", "").replace("Lop ", "")}
                    </AttendanceStickyCell>
