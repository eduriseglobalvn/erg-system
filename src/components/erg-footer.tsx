...
export function ErgFooter({ className = "" }: ErgFooterProps) {
  return (
    <footer className={`relative bg-[#F5F7FA] pt-7 font-sans text-[#00008b] ${className}`}>
          ...
          <div>
            <div className="flex items-center gap-3">
              <img
                ...
                width={82}
              />
              <span className="text-base font-extrabold tracking-tight text-[#00008b]">Edurise Global</span>
            </div>
      ...
      <div className="relative w-full">
        ...
        <div className="relative z-20 bg-[#00008b] py-3">
          <div className="container mx-auto flex flex-col items-center justify-between gap-3 px-4 text-xs text-blue-200/80 md:flex-row md:px-6">
...
function ContactColumn({
  ...
  return (
    <div>
      <h3 className="relative mb-4 inline-block text-sm font-bold uppercase tracking-wide text-[#00008b]">
        {title}
...
function ContactLink({
  ...
  return (
    <a
      className="group flex items-start gap-3 font-semibold leading-5 text-[#00008b] transition-colors hover:text-[#cc0022]"
      href={href}
