...
const hotspotMockImage = `data:image/svg+xml,${encodeURIComponent(`
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 675">
    ...
    <text x="215" y="200" font-family="Segoe UI, Aptos, Arial, sans-serif" font-size="30" font-weight="700" fill="#ffffff">System Settings</text>
    <text x="660" y="345" font-family="Segoe UI, Aptos, Arial, sans-serif" font-size="32" font-weight="700" fill="#0f172a">Version 23H2</text>
    <text x="660" y="392" font-family="Segoe UI, Aptos, Arial, sans-serif" font-size="24" fill="#475569">Build 22631</text>
  </svg>
`)}`;
...
function createCableMockImage(label: string, color: string) {
  return `data:image/svg+xml,${encodeURIComponent(`
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 240 240">
      ...
      <text x="120" y="222" text-anchor="middle" font-family="Segoe UI, Aptos, Arial, sans-serif" font-size="20" font-weight="700" fill="#334155">${label}</text>
    </svg>
  `)}`;
}
